...
python run_ns.py --rho_6t 0.001 --gamma_s 2.25 --rho_6t_max 0.006 --calc-bf &
python run_ns.py --rho_6t 0.001 --gamma_s 2.30 --rho_6t_max 0.008 --calc-bf &
python run_ns.py --rho_6t 0.001 --gamma_s 2.40 --rho_6t_max 0.008 --calc-bf &
python run_ns.py --rho_6t 0.001 --gamma_s 2.50 --rho_6t_max 0.009 --calc-bf &
