...
from pydd.binary import MSUN, PC, get_rho_s
from utils import (
    get_loglikelihood,
    get_loglikelihood_v,
    get_ptform,
...
def run_ns_v(dd_s, f_l, base_path, dM_chirp_v_min, dM_chirp_v_max):
    # Setup
...
def run_ns(dd_s, f_l, base_path, rho_6T_min, rho_6T_max, dM_chirp_abs, gamma_s, rho_6T):
    # Setup
